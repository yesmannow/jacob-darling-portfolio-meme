  ...
  try {
    ...
    const data = {
      ...
      colorAnalysis: {
        ...
        darkVibrant: palette.DarkVibrant ? (palette.DarkVibrant.hex || palette.DarkVibrant.getHex?.() || null) : null,
        lightVibrant: palette.LightVibrant ? (palette.LightVibrant.hex || palette.LightVibrant.getHex?.() || null) : null
      }
    };
