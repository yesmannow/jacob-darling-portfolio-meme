...
export const projects: Project[] = [
  {
    slug: "317-bbq",
    title: "317 BBQ",
    description: "A modern restaurant website showcasing authentic BBQ cuisine with online ordering capabilities.",
    longDescription: "Designed and developed a full-featured restaurant website for 317 BBQ featuring an intuitive menu system, online ordering integration, and responsive design. The site highlights the restaurant's authentic BBQ offerings with high-quality imagery and streamlined user experience.",
  ...
  },
  {
    ...
    description: "Professional painting and power washing services website with portfolio showcase and quote request system.",
    longDescription: "Created a comprehensive website for Russell Painting Company, Inc. featuring their painting and power washing services. The site includes a portfolio gallery, service descriptions, and an integrated quote request system to streamline customer inquiries.",
  ...
  },
  {
    ...
    description: "Professional law firm website highlighting business transactions and commercial law expertise.",
    longDescription: "Developed a sophisticated website for Tuohy Bailey & Moore LLP, a business-focused law firm. The site features practice area descriptions, attorney profiles, and a professional design that reflects the firm's expertise in business transactions and commercial law.",
    image: "/images/projects/Tuohy Bailey & Moore LLP/Screenshot of Home - Tuohy Bailey & Moore LLP.jpg",
    gallery: [
  ...
  },
  {
    ...
    description: "Law firm website showcasing legal expertise with attorney profiles and practice areas.",
    longDescription: "Built a comprehensive website for Riley Bennett Egloff LLP featuring detailed attorney profiles, practice area information, and client resources. The design emphasizes professionalism while maintaining accessibility and user-friendly navigation.",
