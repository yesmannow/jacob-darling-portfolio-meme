          ...
          <div className="bio-container">
            ...
            >
              <motion.h2 variants={staggerItem}>
                Hi, I'm <span className="highlight">Jacob</span>
              </motion.h2>
              <motion.p className="bio-intro" variants={staggerItem}>
                I turn complex marketing challenges into clear, automated systems that drive results.
              </motion.p>
              <motion.p variants={staggerItem}>
                With a background in strategic marketing and a passion for automation, I help businesses streamline their operations, optimize their customer journeys, and scale efficiently. From marketing automation to custom web solutions, I build systems that work.
              </motion.p>
              <motion.div className="bio-contact" variants={staggerItem}>
                <a href="mailto:jacob@jacobdarling.com" className="email-link">
                  jacob@jacobdarling.com
                </a>
              </motion.div>
              <motion.div className="bio-ctas" variants={staggerItem}>
